--
-- APIOAK Router FFI Bindings
-- 
-- LuaJIT FFI 绑定，加载 libapioak_router 动态库
--
...
-- 获取项目根目录 (从 apioak/sys/router/ 向上三级)
local function get_project_root()
    local script_dir = get_script_dir()
    -- 从 apioak/sys/router/ 回到项目根目录
...
local function get_lib_paths()
    ...
    local paths = {
        -- 开发模式 (相对于项目根目录)
        root .. "lua_modules/lib/libapioak_router" .. ext,
        root .. "deps/apioak/libapioak_router" .. ext,
        -- 当前工作目录
        "./lua_modules/lib/libapioak_router" .. ext,
        "./deps/apioak/libapioak_router" .. ext,
        -- 安装模式
        "/usr/local/apioak/lib/libapioak_router" .. ext,
        "/usr/local/lib/libapioak_router" .. ext,
    }
    return paths
end
...
function _M.load()
    ...
    lib_error = "Failed to load libapioak_router:\n" .. table.concat(errors, "\n")
