local config = require("nyro.core.config")
...
_M.REQUEST_API_ENV_KEY       = "NYRO-API-ENV"

_M.REQUEST_ADMIN_TOKEN_KEY   = "NYRO-ADMIN-TOKEN"

_M.RESPONSE_MOCK_REQUEST_KEY = "NYRO-MOCK-REQUEST"
...
_M.RESOURCE_SERVICES = "services"
_M.RESOURCE_ROUTERS = "routers"
_M.RESOURCE_PLUGINS = "plugins"
_M.RESOURCE_UPSTREAMS = "upstreams"
_M.RESOURCE_CERTIFICATES = "certificates"
_M.RESOURCE_UPSTREAM_NODES = "upstream_nodes"

-- Legacy constants (backward compatibility aliases, will be removed in future)
_M.CONSUL_PRFX_SERVICES = _M.RESOURCE_SERVICES
_M.CONSUL_PRFX_ROUTERS = _M.RESOURCE_ROUTERS
_M.CONSUL_PRFX_PLUGINS = _M.RESOURCE_PLUGINS
_M.CONSUL_PRFX_UPSTREAMS = _M.RESOURCE_UPSTREAMS
_M.CONSUL_PRFX_CERTIFICATES = _M.RESOURCE_CERTIFICATES
_M.CONSUL_PRFX_UPSTREAM_NODES = _M.RESOURCE_UPSTREAM_NODES
